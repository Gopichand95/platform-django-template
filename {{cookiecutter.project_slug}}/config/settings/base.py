...
LOCAL_APPS = [
    ...
    "{{ cookiecutter.project_slug }}.domain_events",
...
STATICFILES_DIRS = [
    str(APPS_DIR / "static"),
    str(BASE_DIR / "apps" / "{{ cookiecutter.project_slug }}" / "dist"),
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "{{ cookiecutter.project_slug }}.core.pagination.DefaultPagination",
}
...
DJANGO_VITE = {
    "{{ cookiecutter.project_slug }}": {
        ...
        "static_url_prefix": "{{ cookiecutter.project_slug }}",
        "manifest_path": str(
            BASE_DIR / "apps" / "{{ cookiecutter.project_slug }}" / "dist" / "{{ cookiecutter.project_slug }}" / "manifest.json",
        ),
    },
}
