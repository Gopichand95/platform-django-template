...
# Heroku deployment requires Whitenoise for static files
if "{{ cookiecutter.use_heroku }}".lower() == "y" and "{{ cookiecutter.use_whitenoise }}".lower() == "n":
    print("Heroku deployment requires Whitenoise for serving static files")
    sys.exit(1)
